...
#' library(spatInfer)
#' data(opportunity)
#' # Choose 100 observations and run simulations to speed things up.
#' set.seed(123)
...
#'
#' synth_table(syn_im,adjust="IM")


synth_im=function(fm,df,splines,pc_num,
                     nSim=1000,weights=FALSE,max_clus=6,
                     Parallel=FALSE,exact_cholesky=TRUE,k_medoids=TRUE,jitter_coords=TRUE){
#
...
# Get spatial correlation pattern of residuals and generate synth noise with the same structure.
...
# Get p values of synth variables in simulated regressions both for IM and HC standard errors.
